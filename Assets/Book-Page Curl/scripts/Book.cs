...
public class Book : MonoBehaviour {
    ...
    //遊戲
    public GameObject d,s, colorcan0;
    start p;
  
    public GameObject[] Storyanim;
   // public Animator[] anim;
    public GameObject[] Nextput;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.U))
        {
            ...
            colorcan0.SetActive(true);
            p.StartCoroutine(p.an());
            p.StartCoroutine(p.cc());
            p.StartCoroutine(p.move());
            Cursor.visible = false;
            Storyanim[5].SetActive(false);
            Nextput[2].SetActive(true);
        }

    }

    public void start()  //遊戲
    {
    ...
    IEnumerator pp()
    {
        ...
        Nextput[0].SetActive(true);
    }
    IEnumerator pp1()
    {
        yield return new WaitForSeconds(4);
        Nextput[1].SetActive(true);
    }

    IEnumerator sa()
    {
        yield return new WaitForSeconds(1.5f);
        Storyanim[0].SetActive(true);
    }
    IEnumerator sa1()
    {
        yield return new WaitForSeconds(1.5f);
        Storyanim[1].SetActive(true);
    }
    IEnumerator sa2()
    {
        yield return new WaitForSeconds(1.5f);
        Storyanim[2].SetActive(true);
    }
    IEnumerator sa3()
    {
        yield return new WaitForSeconds(1.5f);
        Storyanim[3].SetActive(true);
    }
    IEnumerator sa4()
    {
        yield return new WaitForSeconds(1.5f);
        Storyanim[4].SetActive(true);
    }
    IEnumerator sa5()
    {
        yield return new WaitForSeconds(1.5f);
        Storyanim[5].SetActive(true);
    }
